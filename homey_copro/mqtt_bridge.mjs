...
const MQTT_URL    = process.env.MQTT_URL || 'mqtt://addon_core_mosquitto:1883';
const MQTT_USER   = process.env.MQTT_USER || 'ha-mqtt-user';
const MQTT_PASS   = process.env.MQTT_PASSWORD || 'ha-mqtt-user';
